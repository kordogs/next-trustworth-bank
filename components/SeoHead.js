...
const defaultMeta = {
  ...
  image:
    "https://next-trustworth-bank.vercel.app//assets/People_pay_bills_mobile_banking-removebg-preview.png",
  author: "Julian Espiloy",
};
...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      <meta name="msapplication-TileImage" content="/public/assets/Logo.svg" />
